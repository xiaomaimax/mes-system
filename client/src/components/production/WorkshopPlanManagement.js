  ...
  const planData = [
    {
      ...
      processRoute: '工艺路线A',
      planDate: '2024-01-15',
      issueTime: '2024-01-10 09:00',
      status: 'pending',
      remarks: '紧急订单，优先生产'
    },
    {
      key: '2',
      planNumber: 'WP-2024-002',
        ...
        >
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div>
              <Form.Item
                name="planNumber"
                label={<span><span style={{ color: 'red' }}>*</span> 计划单号</span>}
              ...
              <Form.Item
                name="planQuantity"
                label={<span><span style={{ color: 'red' }}>*</span> 计划数量</span>}
            ...
            <div>
              <Form.Item
                name="planType"
                label={<span><span style={{ color: 'red' }}>*</span> 计划类型</span>}
                rules={[{ required: true, message: '请选择计划类型' }]}
              >
                <Select placeholder="生产计划">
                  <Option value="生产计划">生产计划</Option>
                  <Option value="维护计划">维护计划</Option>
                  <Option value="测试计划">测试计划</Option>
                </Select>
              </Form.Item>
...
export default WorkshopPlanManagement;