...
import { Card, Row, Col, Button, Space, Statistic, Progress, Tabs, Badge, List, Avatar, Alert, Timeline, Divider, Table, Tag, Switch } from 'antd';
import { 
  LinkOutlined, 
  ApiOutlined, 
  DatabaseOutlined, 
...
import SyncMonitoring from './integration/SyncMonitoring';
...
import PerformanceMonitoring from './integration/PerformanceMonitoring';
import SecuritySettings from './integration/SecuritySettings';
import SyncScheduler from './integration/SyncScheduler';
import DataTransformEngine from './integration/DataTransformEngine';
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col span={6}>
            <Card 
              hoverable 
              size="small" 
              onClick={() => setActiveTab('sync-monitoring')}
              style={{ textAlign: 'center', cursor: 'pointer' }}
            >
          ...
          <Col span={6}>
            <Card 
              hoverable 
              size="small" 
              onClick={() => setActiveTab('sync-scheduler')}
              style={{ textAlign: 'center', cursor: 'pointer' }}
            >
              <Avatar size={48} style={{ backgroundColor: '#722ed1', marginBottom: '8px' }}>
                <ScheduleOutlined />
              </Avatar>
              <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>同步调度</div>
              <div style={{ fontSize: '12px', color: '#666' }}>
                定时任务和调度管理
              </div>
            </Card>
          ...
          <Col span={6}>
            <Card 
              hoverable 
              size="small" 
              onClick={() => setActiveTab('data-transform')}
              style={{ textAlign: 'center', cursor: 'pointer' }}
            >
              <Avatar size={48} style={{ backgroundColor: '#13c2c2', marginBottom: '8px' }}>
                <FunctionOutlined />
              </Avatar>
              <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>数据转换</div>
              <div style={{ fontSize: '12px', color: '#666' }}>
                转换规则和引擎管理
              </div>
            </Card>
          ...
          <Col span={6}>
            ...
            >
              ...
              <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>API文档</div>
              <div style={{ fontSize: '12px', color: '#666' }}>
                接口文档和调用示例
              </div>
            </Card>
          ...
          <Col span={6}>
            ...
            >
              ...
              <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>异常处理</div>
              <div style={{ fontSize: '12px', color: '#666' }}>
                错误日志和异常处理机制
              </div>
            </Card>
          ...
          <Col span={6}>
            ...
            >
              ...
              <div style={{ fontWeight: 'bold', marginBottom: '4px' }}>性能监控</div>
              <div style={{ fontSize: '12px', color: '#666' }}>
                接口性能和响应时间监控
              </div>
            </Card>
